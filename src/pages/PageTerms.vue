                ...
                <div class="q-mx-auto q-mt-xl">
                    <div class="text-body1" style="line-height: 1.8">
                        ...
                        <q-list dark>
                            <q-item class="q-pa-none">
                                <q-item-section class="q-my-md">
                                    <q-item-label class="text-h5">1. Acceptance</q-item-label>
                                    <q-item-label class="q-mt-md">
                                        By using Synque you accept these Terms. If you are under the
                                        legal age in your country, your parent or guardian must
                            ...
                            <q-item class="q-pa-none">
                                <q-item-section class="q-my-md">
                                    ...
                                    <q-item-label class="q-mt-md">
                                        ...
                                        intelligence. Users cannot upload their own content.
                                    </q-item-label>
                                </q-item-section>
                            </q-item>
                            ...
                            <q-item class="q-pa-none">
                                <q-item-section class="q-my-md">
                                    <q-item-label class="text-h5">3. Images in Decks</q-item-label>
                                    <q-item-label class="q-mt-md">
                            ...
                            <q-item class="q-pa-none">
                                <q-item-section class="q-my-md">
                                    <q-item-label class="text-h5">7. Termination</q-item-label>
                                    <q-item-label class="q-mt-md">
                                        We may block or delete your account at any time without
                                        notice.
                                    </q-item-label>
                                </q-item-section>
                            </q-item>
                            ...
                            <q-item class="q-pa-none">
                                <q-item-section class="q-my-md">
                                    <q-item-label class="text-h5">9. Governing Law</q-item-label>
                                    <q-item-label class="q-mt-md">
                                        Laws of the Czech Republic apply. Mandatory consumer
                                        protection rules of Czech Republic, Germany, and Austria
                                        remain unaffected.
                                    </q-item-label>
                                </q-item-section>
                            </q-item>
                        ...
                        <div class="q-mt-lg text-center">
                            <div class="q-mb-xs">Got questions? Talk to us</div>
                            <a
